...
# ADDITIONS TO USER FROM CONSOLE WHEN DOING HOMEWORK:
# u5 = User.create!(name: 'Baloney', role: 'moderator', email: 'baloney@baloney.com', password: 'baloney', password_confirmation: 'baloney')
# u6 = User.create!(name: 'Costa', role: 'chef', email: 'costa@costa.com', password: 'costa', password_confirmation: 'costa')
